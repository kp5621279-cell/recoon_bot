...
ytdl_format_options = {
    ...
    # YouTube ka bot-check client-wise alag hota hai: ye chain try karta hai
    # tv_simply -> tv -> android -> web. Android abhi sabse reliable hai,
    # tv clients bhi aksar bina cookies chal jate hain.
